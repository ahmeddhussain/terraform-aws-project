...
This project provisions a production-style 3-tier AWS architecture using Terraform and a modular structure. It is designed to be clear, reusable, and strong enough to showcase in a CV or portfolio.
